            ...
            <div className="text-center p-6">
              ...
              <Link href={`/creators/${post.creatorId}`}>
                <Button className="gradient-primary w-full">
                  Subscribe - €{post.creator?.subscriptionFee || '9.99'}/month
                </Button>
              </Link>
            </div>
          </div>
        ...
        {showCommentDialog && (
          <div className="fixed inset-0 z-50 flex items-end lg:items-center justify-center bg-black/50">
            <motion.div
              ...
              className="w-full max-w-md bg-background rounded-t-2xl lg:rounded-2xl shadow-lg flex flex-col max-h-[80vh]"
            >
              {/* Header */}
              ...
              {/* Comment Form */}
              <div className="border-t border-border p-6 bg-sidebar">
